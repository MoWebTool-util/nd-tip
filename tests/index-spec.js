...
describe('Tip', function() {
  ...
  it('content', function() {
    ...
    tip.show();
    expect(tip.$('[data-role=content]').html()).to.be(CONTENT);
  });
  ...
  it('content from function', function() {
    ...
    tip.show();
    expect(tip.$('[data-role="content"]').html()).to.be('test content');
  });
  ...
  it('set size', function() {
    ...
    tip.show();
    expect(tip.$('[data-role="content"]').width()).to.be(600);
    expect(tip.$('[data-role="content"]').height()).to.be(1024);
  });
